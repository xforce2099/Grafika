...
GLboolean ShaderProgram::SetUniformVariable2i(const GLchar *name, GLfloat parameter_1, GLfloat parameter_2) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable3i(const GLchar *name, GLfloat parameter_1, GLfloat parameter_2, GLfloat parameter_3) const
{
    if (!_program)
        return GL_FALSE;
...
GLboolean ShaderProgram::SetUniformVariable4i(const GLchar *name, GLfloat parameter_1, GLfloat parameter_2, GLfloat parameter_3, GLfloat parameter_4) const
{
    if (!_program)
        return GL_FALSE;

...
namespace cagd
{
    ...
    // default constructor                                  inline koltseg
    ...
    {
        return _data[1]; /* homework */
    }

    inline GLdouble DCoordinate3::z() const
    {
        return _data[2];// homework 
    }
    ...
    inline const DCoordinate3 DCoordinate3::operator -(const DCoordinate3& rhs) const
    {
         return DCoordinate3(_data[0] - rhs._data[0], _data[1] - rhs._data[1], _data[2] - rhs._data[2]); // homework
    }
    ...
    {      
           ...
           _data[2] = z;
           return *this; 
        // homework //temp valtozokat vezess be (feluliras) am ugyan ugy mint az elozo
    }
    ...
    inline const DCoordinate3 operator *(const GLdouble& lhs, const DCoordinate3& rhs)
    {
        ...
        // homework return DCoordinate3 ( lhs * rhs[0], ...  es az osszes tagra meg...
    }

    inline const DCoordinate3 DCoordinate3::operator /(const GLdouble& rhs) const
    {
        return DCoordinate3(_data[0] / rhs, _data[1] / rhs, _data[2] / rhs); // homework
    }
    ...
    {
        return lhs >> rhs[0] >> rhs[1] >> rhs[2];// homework return >> kacsacsorokkel
    }
}
//ki lehet probalni DCoordinate3 i(1,0,0), j(0,1,0);
//DCoordinate3 j = i*j; erre (0,0,1) et kene kiirjon ...
